                             ...
                             gconstpointer user_data)
{
  ...
  resp = perform_http_request (tc->localport, "GET /modules/base/test-dbus.html HTTP/1.0\r\nHost:test\r\n\r\n", &length);
  g_assert (resp != NULL);
                        ...
                        gconstpointer user_data)
{
  ...
  resp = perform_http_request (tc->localport, "GET /modules/base/test-dbus.html?blah HTTP/1.0\r\nHost:test\r\n\r\n", &length);
  g_assert (resp != NULL);
  g_assert_cmpuint (length, >, 0);
                               ...
                               gconstpointer data)
{
  ...
  resp = perform_http_request (tc->hostport, "GET /modules/base/test-dbus.html HTTP/1.0\r\nHost:test\r\n\r\n", NULL);
